import {
  ...
  script2 as script18,
  script3 as script19
} from "./chunk-R6L6QLTQ.js";
import {
  script as script16
} from "./chunk-R42CN6DV.js";
import {
  script as script15
} from "./chunk-BEQEDRFQ.js";
import {
  script as script14
} from "./chunk-MIKTKR5V.js";
import "./chunk-4JHQZMVQ.js";
import "./chunk-6RK4QFKH.js";
import {
  FocusTrap
} from "./chunk-75U263HA.js";
import {
  script as script13
} from "./chunk-IPASPKEF.js";
import "./chunk-P3HBMGJO.js";
import "./chunk-3HHSBYGC.js";
import {
  script as script9
} from "./chunk-WHGE6GWQ.js";
import "./chunk-OLZCJ76O.js";
import {
  OverlayEventBus
...
import {
  script as script5
} from "./chunk-N34U4A24.js";
import {
  script as script6
} from "./chunk-MEVH4WNH.js";
import {
  script2 as script12
} from "./chunk-TPNUIQZ6.js";
import {
  script as script11
} from "./chunk-XONEXOZ4.js";
import "./chunk-TDABCWGA.js";
import "./chunk-N3U5JRAJ.js";
import {
  FilterMatchMode,
  FilterOperator,
  FilterService
} from "./chunk-CCBUE7KU.js";
import {
  script as script3
    ...
    updateStickyPosition: function updateStickyPosition() {
      if (this.columnProp("frozen")) {
        ...
        if (align === "right") {
          ...
          if (next) {
            pos = v(next) + parseFloat(next.style["inset-inline-end"] || 0);
          }
          ...
          if (prev) {
            _pos = v(prev) + parseFloat(prev.style["inset-inline-start"] || 0);
          }
...
var script28 = {
  ...
  data: function data10() {
    return {
      ...
      d_multiSortMeta: this.multiSortMeta ? _toConsumableArray9(this.multiSortMeta) : [],
  ...
  methods: {
    ...
    sortSingle: function sortSingle(value) {
      ...
      var data11 = _toConsumableArray9(value);
    ...
    sortMultiple: function sortMultiple(value) {
      ...
      if (this.groupRowsBy && (this.d_groupRowsSortMeta || this.d_multiSortMeta.length && this.groupRowsBy === this.d_multiSortMeta[0].field)) {
        ...
        if (firstSortMeta.field !== this.d_groupRowsSortMeta.field) {
          this.d_multiSortMeta = [this.d_groupRowsSortMeta].concat(_toConsumableArray9(this.d_multiSortMeta));
        }
      }
      var data11 = _toConsumableArray9(value);
      data11.sort(function(data1, data22) {
    ...
    addMultiSortField: function addMultiSortField(field2) {
      ...
      this.d_multiSortMeta = _toConsumableArray9(this.d_multiSortMeta);
    },
      ...
      for (var i = 0; i < data11.length; i++) {
        ...
        if (localMatch && activeFilters["global"] && !globalMatch && globalFilterFieldsArray) {
          for (var j = 0; j < globalFilterFieldsArray.length; j++) {
            ...
            globalMatch = FilterService.filters[activeFilters["global"].matchMode || FilterMatchMode.CONTAINS](p(data11[i], globalFilterField), activeFilters["global"].value, this.filterLocale);
            if (globalMatch) {
              break;
            }
          }
          ...
          if (metaSelection) {
            ...
            if (selected && metaKey) {
              ...
              if (this.isSingleSelectionMode()) {
                ...
                _selection2 = [].concat(_toConsumableArray9(_selection2), [rowData2]);
            ...
            if (this.selectionMode === "single") {
              ...
              if (selected) {
                ...
                var _selection4 = this.selection ? [].concat(_toConsumableArray9(this.selection), [rowData2]) : [rowData2];
    ...
    onSpaceKey: function onSpaceKey(event, rowData2, rowIndex2, slotProps) {
      ...
      if (event.shiftKey && this.selection !== null) {
        ...
        if (this.selection.length > 0) {
          ...
          firstSelectedRowIndex = h(this.selection[0], data11);
          lastSelectedRowIndex = h(this.selection[this.selection.length - 1], data11);
          index = rowIndex2 <= firstSelectedRowIndex ? lastSelectedRowIndex : firstSelectedRowIndex;
        } else {
          index = h(this.selection, data11);
        }
    ...
    onTabKey: function onTabKey(event, rowIndex2) {
      var body = this.$refs.bodyRef && this.$refs.bodyRef.$el;
      var rows2 = Y(body, 'tr[data-p-selectable-row="true"]');
    ...
    findLastSelectableRow: function findLastSelectableRow() {
      var rows2 = Y(this.$refs.table, 'tr[data-p-selectable-row="true"]');
    ...
    toggleRowWithCheckbox: function toggleRowWithCheckbox2(event) {
      ...
      if (this.isSelected(rowData2)) {
        ...
        var _selection5 = this.selection ? _toConsumableArray9(this.selection) : [];
        _selection5 = [].concat(_toConsumableArray9(_selection5), [rowData2]);
    ...
    toggleRowsWithCheckbox: function toggleRowsWithCheckbox(event) {
      if (this.selectAll !== null) {
        ...
        var _selection = [];
        if (checked) {
          _selection = this.frozenValue ? [].concat(_toConsumableArray9(this.frozenValue), _toConsumableArray9(this.processedData)) : this.processedData;
      ...
      if (Array.isArray(selection)) {
        ...
        try {
          for (_iterator3.s(); !(_step3 = _iterator3.n()).done; ) {
            ...
            this.d_selectionKeys[String(p(data11, this.dataKey))] = 1;
          }
        } catch (err) {
          _iterator3.e(err);
        } finally {
      ...
      if (editingRows && editingRows.length) {
        ...
        try {
          for (_iterator4.s(); !(_step4 = _iterator4.n()).done; ) {
            ...
            this.d_editingRowKeys[String(p(data11, this.dataKey))] = 1;
          }
        } catch (err) {
          _iterator4.e(err);
        } finally {
    ...
    generateCSV: function generateCSV(options, data11) {
      ...
      if (!data11) {
        ...
        else if (this.frozenValue) data11 = data11 ? [].concat(_toConsumableArray9(this.frozenValue), _toConsumableArray9(data11)) : this.frozenValue;
      }
    ...
    onColumnHeaderDrop: function onColumnHeaderDrop(e) {
      ...
      if (this.draggedColumnElement) {
        ...
        if (allowDrop) {
          ...
          var reorderedWidths = [].concat(_toConsumableArray9(remainingItems.slice(0, dropColIndex)), [movedItem], _toConsumableArray9(remainingItems.slice(dropColIndex)));
    ...
    onRowDrop: function onRowDrop2(event) {
      if (this.droppedRowIndex != null) {
        ...
        var processedData2 = _toConsumableArray9(this.processedData);
    ...
    toggleRow: function toggleRow2(event) {
      ...
      if (this.dataKey) {
        ...
        expandedRows = this.expandedRows ? _toConsumableArray9(this.expandedRows) : [];
    ...
    toggleRowGroup: function toggleRowGroup(e) {
      var event = e.originalEvent;
      var data11 = e.data;
      var groupFieldValue = p(data11, this.groupRowsBy);
      var _expandedRowGroups = this.expandedRowGroups ? _toConsumableArray9(this.expandedRowGroups) : [];
    ...
    onRowEditInit: function onRowEditInit3(event) {
      var _editingRows = this.editingRows ? _toConsumableArray9(this.editingRows) : [];
      _editingRows.push(event.data);
      this.$emit("update:editingRows", _editingRows);
      this.$emit("row-edit-init", event);
    },
    onRowEditSave: function onRowEditSave3(event) {
      var _editingRows = _toConsumableArray9(this.editingRows);
  ...
  computed: {
    columns: function columns() {
      ...
      if (cols && this.reorderableColumns && this.d_columnOrder) {
        ...
        return [].concat(orderedColumns, _toConsumableArray9(cols.filter(function(item) {
    ...
    allRowsSelected: function allRowsSelected() {
      ...
      if (this.selectAll !== null) {
        ...
        var val = this.frozenValue ? [].concat(_toConsumableArray9(this.frozenValue), _toConsumableArray9(this.processedData)) : this.processedData;
