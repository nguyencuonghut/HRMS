import {
  script as script8
} from "./chunk-RY6KPIHY.js";
import {
  script as script7
} from "./chunk-WWNSLYRY.js";
import {
  script as script6
...
var script10 = {
  ...
  methods: {
        ...
        xhr.onreadystatechange = function() {
          if (xhr.readyState === 4) {
            ...
            if (xhr.status >= 200 && xhr.status < 300) {
              ...
              (_this$uploadedFiles = _this.uploadedFiles).push.apply(_this$uploadedFiles, _toConsumableArray2(_this.files));
            } else {
              _this.$emit("error", {
                xhr,
                files: _this.files
    ...
    onDragOver: function onDragOver(event) {
      if (!this.disabled && (!this.hasFiles || this.multiple)) {
        !this.isUnstyled && W(this.$refs.content, "p-fileupload-highlight");
    ...
    onDragLeave: function onDragLeave() {
      if (!this.disabled) {
        !this.isUnstyled && P(this.$refs.content, "p-fileupload-highlight");
    ...
    remove: function remove(index) {
      ...
      this.files = _toConsumableArray2(this.files);
      this.$emit("remove", {
        file: removedFile,
        files: this.files
      });
    ...
    removeUploadedFile: function removeUploadedFile(index) {
      ...
      this.uploadedFiles = _toConsumableArray2(this.uploadedFiles);
...
function render2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, _ctx.ptm("input")), null, 16, _hoisted_1), createBaseVNode("div", mergeProps({
