...
function D(t2, e, o = true) {
  var n, r, i2, l2;
  if (t2) {
    let d = t2.offsetParent ? { width: t2.offsetWidth, height: t2.offsetHeight } : w2(t2), s4 = d.height, a2 = d.width, u = e.offsetHeight, p = e.offsetWidth, f2 = e.getBoundingClientRect(), g2 = $(), it = k(), lt = h(), L, N2, ot = "top";
...
function I(t2, e, o = true, n = void 0) {
  var r;
  if (t2) {
    let i2 = t2.offsetParent ? { width: t2.offsetWidth, height: t2.offsetHeight } : w2(t2), l2 = e.offsetHeight, d = e.getBoundingClientRect(), s4 = h(), a2, u, p = n != null ? n : "top";
...
var D2 = (e, t2, r) => {
  e = Te(e), t2 = Te(t2);
  let a2 = (r / 100 * 2 - 1 + 1) / 2, n = 1 - a2, l2 = Ne(e), o = Ne(t2), c2 = Math.round(l2.r * a2 + o.r * n), m2 = Math.round(l2.g * a2 + o.g * n), d = Math.round(l2.b * a2 + o.b * n);
  return gt(c2, m2, d);
};
...
var w3 = (e = {}) => {
  ...
  return { preset(s4) {
    ...
    let { semantic: i2 } = t2 || {};
    return t2 = $2(h2({}, t2), { semantic: $2(h2({}, i2), { primary: s4 }) }), this;
  }, surfacePalette(s4) {
    var o, c2;
    ...
    return t2 = $2(h2({}, t2), { semantic: h2(h2({}, i2), l2) }), this;
...
var b2 = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(e) {
  ...
  if (s(t2)) {
    ...
    if (s4 !== "style") {
      ...
      t2 = r === "dark" ? c2.reduce((m2, { type: d, selector: u }) => (s(u) && (m2 += u.includes("[CSS]") ? u.replace("[CSS]", t2) : this.getSelectorRule(u, l2, d, t2)), m2), "") : C3(l2 != null ? l2 : ":root,:host", t2);
    }
    if (o) {
...
var ge = class {
  ...
  add(t2, r) {
    if (s(r)) {
      ...
      this._styles.set(t2, $2(h2({}, s4), { element: this.createStyleElement(s4) }));
    }
  }
  update() {
  }
...
//# sourceMappingURL=chunk-DRWS4XVE.js.map
