...
def test_validate_dual_location_paths_success(client: TestClient):
    new_provinces = client.get("/api/v1/locations/provinces", params={"system_type": "new"}).json()
    ...
    old_provinces = client.get("/api/v1/locations/provinces", params={"system_type": "old"}).json()
