...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("health_care_insurance_code", sa.String(length=50), nullable=True),
        sa.Column("health_care_family_participation", sa.Boolean(), nullable=True),
        sa.Column("accident_insurance_code", sa.String(length=50), nullable=True),
