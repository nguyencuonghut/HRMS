...
CONTRACT_TEMPLATE_PLACEHOLDERS = {
    "ld_indefinite": [
        ...
        ("contract_signing_date_full", "Ngày ký hợp đồng (đầy đủ)", "contract_draft", "contract.signed_date_full", "date", None, False, None, 160),
    ],
    "ld_definite_12m": [
        ("contract_number", "Số hợp đồng", "contract_draft", "contract.contract_number", "text", None, True, None, 10),
        ("employee_full_name", "Họ và tên", "employee", "employee.full_name", "text", None, True, None, 20),
        ...
        ("contract_signing_date_full", "Ngày ký hợp đồng (đầy đủ)", "contract_draft", "contract.signed_date_full", "date", None, False, None, 170),
        ("SĐT", "Số điện thoại", "employee", "employee.phone_number", "text", None, False, None, 180),
        ("Loại_HĐLĐ__", "Loại hợp đồng", "contract_draft", "contract.contract_type_label", "text", None, False, None, 190),
        ("Thời_hạn_trả_lương", "Kỳ hạn trả lương", "contract_draft", "contract.pay_cycle_label", "text", None, False, None, 200),
    ],
    "probation_standard": [
        ("contract_number", "Số hợp đồng", "contract_draft", "contract.contract_number", "text", None, True, None, 10),
        ("employee_full_name", "Họ và tên", "employee", "employee.full_name", "text", None, True, None, 20),
        ...
        ("contract_signing_day", "Ngày ký hợp đồng (ngày)", "contract_draft", "contract.signed_date.day", "number", None, False, None, 160),
        ("contract_signing_month", "Ngày ký hợp đồng (tháng)", "contract_draft", "contract.signed_date.month", "number", None, False, None, 170),
        ("contract_signing_year", "Ngày ký hợp đồng (năm)", "contract_draft", "contract.signed_date.year", "number", None, False, None, 180),
        ("contract_signing_date_full", "Ngày ký hợp đồng (đầy đủ)", "contract_draft", "contract.signed_date_full", "date", None, False, None, 190),
    ],
