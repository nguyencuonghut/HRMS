...
SUPPORTED_TEMPLATE_FIELDS: dict[str, SupportedTemplateField] = {
    ...
    "contract_signing_date_full": SupportedTemplateField(
        token="contract_signing_date_full",
        label="Ngày ký hợp đồng (đầy đủ)",
        source_scope="contract_draft",
        source_path="contract.signed_date_full",
        source_origin="employee_contracts.signed_date -> 'ngày dd tháng mm năm yyyy'",
        data_type="date",
        formatter="vn_date_clause",
    ),
    "contract_signing_day": SupportedTemplateField(
        token="contract_signing_day",
        label="Ngày ký hợp đồng (ngày)",
        source_scope="contract_draft",
        source_path="contract.signed_date.day",
        source_origin="employee_contracts.signed_date.day",
        data_type="number",
    ),
    "contract_signing_month": SupportedTemplateField(
        token="contract_signing_month",
        label="Ngày ký hợp đồng (tháng)",
        source_scope="contract_draft",
        source_path="contract.signed_date.month",
        source_origin="employee_contracts.signed_date.month",
        data_type="number",
    ),
    "contract_signing_year": SupportedTemplateField(
        token="contract_signing_year",
        label="Ngày ký hợp đồng (năm)",
        source_scope="contract_draft",
        source_path="contract.signed_date.year",
